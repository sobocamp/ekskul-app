...
class PembinaStoreRequest extends FormRequest
{
    ...
    /**
     * Aturan validasi untuk permintaan pembuatan pembina baru.
     *
     ...
     * - **role**: wajib diisi dan harus bernilai 'pembina'.
     *
     * Request ini digunakan pada proses penyimpanan pembina baru di
     * `PembinaController@store`.
     *
    ...
    public function rules(): array
    {
        return [
            ...
            // Role hanya diperbolehkan berisi 'pembina'
